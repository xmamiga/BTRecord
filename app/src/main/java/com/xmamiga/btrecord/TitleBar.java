...
public class TitleBar extends ViewGroup implements View.OnClickListener {
    ...
    private static final int DEFAULT_TITLE_BAR_HEIGHT = 52;
    ...
    public void setImmersive(boolean immersive) {
        ...
        if (mImmersive) {
            mStatusBarHeight = getStatusBarHeight();
            addView(mStatusBarView, new LayoutParams(LayoutParams.MATCH_PARENT, mStatusBarHeight));
        } else {
            mStatusBarHeight = 0;
        }
    }
...
//    }
    ...
    public void setDisplayShowHomeEnabled(boolean isEnabled) {
        if (isEnabled) {
            mLeftText.setCompoundDrawablesWithIntrinsicBounds(R.drawable.back, 0, 0, 0);
            mLeftText.setEnabled(true);
        } else {
            mLeftText.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
            mLeftText.setEnabled(false);
        }
    }
...
//    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mImmersive) {
            measureChild(mStatusBarView, widthMeasureSpec, heightMeasureSpec);
        }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (mImmersive) {
            mStatusBarView.layout(0, 0, mScreenWidth, mStatusBarHeight);
        }
    }
